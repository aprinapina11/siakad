	...
	<div class="row">
		<div class="col-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<?php echo form_open('siswa/edit/'.$siswa['id'],array("class"=>"form-horizontal")); ?>
                    <div class="form-group">
						<label for="nama_lengkap" class="col-md-4 control-label"><span class="text-danger">*</span>Nama
							Lengkap</label>
						<div class="col-md-8">
							<input type="text" name="nama_lengkap"
								value="<?php echo ($this->input->post('nama_lengkap') ? $this->input->post('nama_lengkap') : $siswa['nama_lengkap']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="nama_panggilan"
								value="<?php echo ($this->input->post('nama_panggilan') ? $this->input->post('nama_panggilan') : $siswa['nama_panggilan']); ?>"
								class="form-control" id="nama_panggilan" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="nis"
								value="<?php echo ($this->input->post('nis') ? $this->input->post('nis') : $siswa['nis']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="nisn"
								value="<?php echo ($this->input->post('nisn') ? $this->input->post('nisn') : $siswa['nisn']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="nik"
								value="<?php echo ($this->input->post('nik') ? $this->input->post('nik') : $siswa['nik']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="nikk"
								value="<?php echo ($this->input->post('nikk') ? $this->input->post('nikk') : $siswa['nikk']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="tempat_lahir"
								value="<?php echo ($this->input->post('tempat_lahir') ? $this->input->post('tempat_lahir') : $siswa['tempat_lahir']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="date" name="tanggal_lahir"
								value="<?php echo ($this->input->post('tanggal_lahir') ? $this->input->post('tanggal_lahir') : $siswa['tanggal_lahir']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="alamat"
								value="<?php echo ($this->input->post('alamat') ? $this->input->post('alamat') : $siswa['alamat']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="kelurahan"
								value="<?php echo ($this->input->post('kelurahan') ? $this->input->post('kelurahan') : $siswa['kelurahan']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="kecamatan"
								value="<?php echo ($this->input->post('kecamatan') ? $this->input->post('kecamatan') : $siswa['kecamatan']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="kota_kab"
								value="<?php echo ($this->input->post('kota_kab') ? $this->input->post('kota_kab') : $siswa['kota_kab']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="provinsi"
								value="<?php echo ($this->input->post('provinsi') ? $this->input->post('provinsi') : $siswa['provinsi']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="kode_pos"
								value="<?php echo ($this->input->post('kode_pos') ? $this->input->post('kode_pos') : $siswa['kode_pos']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="ayah"
								value="<?php echo ($this->input->post('ayah') ? $this->input->post('ayah') : $siswa['ayah']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="pekerjaan_ayah"
								value="<?php echo ($this->input->post('pekerjaan_ayah') ? $this->input->post('pekerjaan_ayah') : $siswa['pekerjaan_ayah']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="penghasilan_ayah"
								value="<?php echo ($this->input->post('penghasilan_ayah') ? $this->input->post('penghasilan_ayah') : $siswa['penghasilan_ayah']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="ibu"
								value="<?php echo ($this->input->post('ibu') ? $this->input->post('ibu') : $siswa['ibu']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="pekerjaan_ibu"
								value="<?php echo ($this->input->post('pekerjaan_ibu') ? $this->input->post('pekerjaan_ibu') : $siswa['pekerjaan_ibu']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="penghasilan_ibu"
								value="<?php echo ($this->input->post('penghasilan_ibu') ? $this->input->post('penghasilan_ibu') : $siswa['penghasilan_ibu']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="wali"
								value="<?php echo ($this->input->post('wali') ? $this->input->post('wali') : $siswa['wali']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="pekerjaan_wali"
								value="<?php echo ($this->input->post('pekerjaan_wali') ? $this->input->post('pekerjaan_wali') : $siswa['pekerjaan_wali']); ?>"
								class="form-control" id="pekerjaan_wali" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="penghasilan_wali"
								value="<?php echo ($this->input->post('penghasilan_wali') ? $this->input->post('penghasilan_wali') : $siswa['penghasilan_wali']); ?>"
								class="form-control" id="penghasilan_wali" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="tanggal_masuk"
								value="<?php echo ($this->input->post('tanggal_masuk') ? $this->input->post('tanggal_masuk') : $siswa['tanggal_masuk']); ?>"
								class="form-control" id="tanggal_masuk" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="telp_siswa"
								value="<?php echo ($this->input->post('telp_siswa') ? $this->input->post('telp_siswa') : $siswa['telp_siswa']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="telp_ayah"
								value="<?php echo ($this->input->post('telp_ayah') ? $this->input->post('telp_ayah') : $siswa['telp_ayah']); ?>"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="telp_ibu"
								value="<?php echo ($this->input->post('telp_ibu') ? $this->input->post('telp_ibu') : $siswa['telp_ibu']); ?>"
